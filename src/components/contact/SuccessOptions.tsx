  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto lg:divide-x lg:divide-border">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-card p-6 sm:p-8 lg:pr-12">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-card p-6 sm:p-8 hover:shadow-elegant transition-all duration-300 lg:pl-12">
      ...
      {/* New Request Button */}
      <div className="text-center px-4 mt-8 sm:mt-12">
        <Button
          variant="outline"
